...
public class CreateComponentTs extends AngularComponentGenerator {
    @Override
    public String template() {
        return "/templates/angular/create.component.ts.vm";
    }

    @Override
    public GenType type() {
        return CustomGenTypes.AngularCreateTs;
    }

    @Override
    public String outputFile(GenConfig config, TableInfo info) {
        return "/a-makes/angular/routes/" + info.getName() + "/modal/create.component.ts";
    }
