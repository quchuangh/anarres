...
public class EditComponentHtml extends AngularComponentGenerator {
    @Override
    public String template() {
        return "/templates/angular/edit.component.html.vm";
    }

    @Override
    public GenType type() {
        return CustomGenTypes.AngularEditHtml;
    }

    @Override
    public String outputFile(GenConfig config, TableInfo info) {
        return "/a-makes/angular/routes/" + info.getName() + "/modal/edit.component.html";
    }
}
